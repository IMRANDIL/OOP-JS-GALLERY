...
//   this.openModal = getElement('.modal');
...
// Gallery.prototype.modalOpen = function (selectedImage, list) {
...
//   }).join('');
//   this.openModal.classList.add('open');
...
// refector the code using Es6 class constructor...
